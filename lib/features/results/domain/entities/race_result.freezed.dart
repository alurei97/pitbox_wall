...
mixin _$RaceResult {
 ...
 String get sessionType; int get round; String get driverId; String get driverCode; String get driverNumber; String get givenName; String get familyName; String get nationality; String get constructorId; String get constructorName; int get position; int get grid; double get points; String get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sessionType,round,driverId,driverCode,driverNumber,givenName,familyName,nationality,constructorId,constructorName,position,grid,points,status);

@override
String toString() {
  return 'RaceResult(sessionType: $sessionType, round: $round, driverId: $driverId, driverCode: $driverCode, driverNumber: $driverNumber, givenName: $givenName, familyName: $familyName, nationality: $nationality, constructorId: $constructorId, constructorName: $constructorName, position: $position, grid: $grid, points: $points, status: $status)';
}
...
@useResult
$Res call({
 String sessionType, int round, String driverId, String driverCode, String driverNumber, String givenName, String familyName, String nationality, String constructorId, String constructorName, int position, int grid, double points, String status
});
...
/// Create a copy of RaceResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionType = null,Object? round = null,Object? driverId = null,Object? driverCode = null,Object? driverNumber = null,Object? givenName = null,Object? familyName = null,Object? nationality = null,Object? constructorId = null,Object? constructorName = null,Object? position = null,Object? grid = null,Object? points = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sessionType,  int round,  String driverId,  String driverCode,  String driverNumber,  String givenName,  String familyName,  String nationality,  String constructorId,  String constructorName,  int position,  int grid,  double points,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RaceResult() when $default != null:
return $default(_that.sessionType,_that.round,_that.driverId,_that.driverCode,_that.driverNumber,_that.givenName,_that.familyName,_that.nationality,_that.constructorId,_that.constructorName,_that.position,_that.grid,_that.points,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sessionType,  int round,  String driverId,  String driverCode,  String driverNumber,  String givenName,  String familyName,  String nationality,  String constructorId,  String constructorName,  int position,  int grid,  double points,  String status)  $default,) {final _that = this;
switch (_that) {
case _RaceResult():
return $default(_that.sessionType,_that.round,_that.driverId,_that.driverCode,_that.driverNumber,_that.givenName,_that.familyName,_that.nationality,_that.constructorId,_that.constructorName,_that.position,_that.grid,_that.points,_that.status);case _:
  throw StateError('Unexpected subclass');
