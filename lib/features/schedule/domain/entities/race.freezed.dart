...
mixin _$Race {
 ...
 int get round; String get raceName; String get circuitName; String get country; DateTime get fp1DateTime; DateTime? get fp2DateTime; DateTime? get sprintDateTime; DateTime? get fp3DateTime; DateTime? get sprintQualifyingDateTime; DateTime get qualifyingDateTime; DateTime get raceDateTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,round,raceName,circuitName,country,fp1DateTime,fp2DateTime,sprintDateTime,fp3DateTime,sprintQualifyingDateTime,qualifyingDateTime,raceDateTime);

@override
String toString() {
  return 'Race(round: $round, raceName: $raceName, circuitName: $circuitName, country: $country, fp1DateTime: $fp1DateTime, fp2DateTime: $fp2DateTime, sprintDateTime: $sprintDateTime, fp3DateTime: $fp3DateTime, sprintQualifyingDateTime: $sprintQualifyingDateTime, qualifyingDateTime: $qualifyingDateTime, raceDateTime: $raceDateTime)';
}
...
@useResult
$Res call({
 int round, String raceName, String circuitName, String country, DateTime fp1DateTime, DateTime? fp2DateTime, DateTime? sprintDateTime, DateTime? fp3DateTime, DateTime? sprintQualifyingDateTime, DateTime qualifyingDateTime, DateTime raceDateTime
});
...
/// Create a copy of Race
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? round = null,Object? raceName = null,Object? circuitName = null,Object? country = null,Object? fp1DateTime = null,Object? fp2DateTime = freezed,Object? sprintDateTime = freezed,Object? fp3DateTime = freezed,Object? sprintQualifyingDateTime = freezed,Object? qualifyingDateTime = null,Object? raceDateTime = null,}) {
  return _then(Race(
...
as String,fp1DateTime: null == fp1DateTime ? _self.fp1DateTime : fp1DateTime // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int round,  String raceName,  String circuitName,  String country,  DateTime fp1DateTime,  DateTime? fp2DateTime,  DateTime? sprintDateTime,  DateTime? fp3DateTime,  DateTime? sprintQualifyingDateTime,  DateTime qualifyingDateTime,  DateTime raceDateTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Race() when $default != null:
return $default(_that.round,_that.raceName,_that.circuitName,_that.country,_that.fp1DateTime,_that.fp2DateTime,_that.sprintDateTime,_that.fp3DateTime,_that.sprintQualifyingDateTime,_that.qualifyingDateTime,_that.raceDateTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int round,  String raceName,  String circuitName,  String country,  DateTime fp1DateTime,  DateTime? fp2DateTime,  DateTime? sprintDateTime,  DateTime? fp3DateTime,  DateTime? sprintQualifyingDateTime,  DateTime qualifyingDateTime,  DateTime raceDateTime)  $default,) {final _that = this;
switch (_that) {
case _Race():
return $default(_that.round,_that.raceName,_that.circuitName,_that.country,_that.fp1DateTime,_that.fp2DateTime,_that.sprintDateTime,_that.fp3DateTime,_that.sprintQualifyingDateTime,_that.qualifyingDateTime,_that.raceDateTime);case _:
  throw StateError('Unexpected subclass');
...
class _Race implements Race {
  const _Race({required this.round, required this.raceName, required this.circuitName, required this.country, required this.fp1DateTime, this.fp2DateTime, this.sprintDateTime, this.fp3DateTime, this.sprintQualifyingDateTime, required this.qualifyingDateTime, required this.raceDateTime});
